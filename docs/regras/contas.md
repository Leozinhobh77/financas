# REGRAS — contas, datas e recorrência

> **RN001 a RN009.** O índice de todas as regras, com o teste de cada uma, está em
> [`../REGRAS-DE-NEGOCIO.md`](../REGRAS-DE-NEGOCIO.md). As regras de **meta** estão em
> [`metas.md`](metas.md).
>
